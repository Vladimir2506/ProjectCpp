...
public:
    ...
    void setupUi(QDialog *OrderSupervise)
    {
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral("Resources/add.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral("Resources/subtract.png"), QSize(), QIcon::Normal, QIcon::Off);
