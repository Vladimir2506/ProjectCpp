...
public:
    ...
    void setupUi(QDialog *ManagerView)
    {
        ...
        gbWaiter = new QGroupBox(ManagerView);
        gbWaiter->setObjectName(QStringLiteral("gbWaiter"));
        gbWaiter->setGeometry(QRect(525, 225, 450, 650));
        cbWaiter = new QComboBox(gbWaiter);
        cbWaiter->setObjectName(QStringLiteral("cbWaiter"));
        cbWaiter->setGeometry(QRect(225, 50, 150, 25));
        lblWaiter = new QLabel(gbWaiter);
        lblWaiter->setObjectName(QStringLiteral("lblWaiter"));
        lblWaiter->setGeometry(QRect(50, 50, 150, 25));
        tbWaiter = new QTableView(gbWaiter);
        tbWaiter->setObjectName(QStringLiteral("tbWaiter"));
        tbWaiter->setGeometry(QRect(50, 100, 350, 200));
        tbWaiter->setEditTriggers(QAbstractItemView::NoEditTriggers);
        tbWaiter->setSelectionMode(QAbstractItemView::SingleSelection);
        tbComm = new QTableView(gbWaiter);
        ...
        QObject::connect(cbWaiter, SIGNAL(currentTextChanged(QString)), ManagerView, SLOT(BindWaiter(QString)));
    ...
    void retranslateUi(QDialog *ManagerView)
    {
        ...
        gbWaiter->setTitle(QApplication::translate("ManagerView", "\346\234\215\345\212\241\345\221\230\345\267\245\344\275\234\346\203\205\345\206\265", Q_NULLPTR));
        lblWaiter->setText(QApplication::translate("ManagerView", "\350\257\267\351\200\211\346\213\251\344\270\200\345\220\215\346\234\215\345\212\241\345\221\230", Q_NULLPTR));
